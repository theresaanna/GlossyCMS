...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE IF EXISTS "pages_blocks_twitter" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE IF EXISTS "_pages_v_blocks_twitter" DISABLE ROW LEVEL SECURITY;
  DROP TABLE IF EXISTS "pages_blocks_twitter" CASCADE;
  DROP TABLE IF EXISTS "_pages_v_blocks_twitter" CASCADE;`)
}
